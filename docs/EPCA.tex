...
\hypersetup{unicode=true,
            pdftitle={Estadística para Contadores y Auditores con R},
            pdfauthor={Oswaldo Navarrete Carreño; María Alexandra Chavez P.},
            pdfborder={0 0 0},
            breaklinks=true}
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/rnl1-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{EPCA_files/figure-latex/figura1-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{EPCA_files/figure-latex/figura2-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{EPCA_files/figure-latex/figura3-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{EPCA_files/figure-latex/histfacet-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/sime1-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/sesgoright-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{EPCA_files/figure-latex/sesgoleft-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{EPCA_files/figure-latex/barras1-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{EPCA_files/figure-latex/barras2-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{EPCA_files/figure-latex/barras3-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{EPCA_files/figure-latex/barras4-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{EPCA_files/figure-latex/figura4-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{EPCA_files/figure-latex/figura5-1} 
...
\item
  ...
  \item
    Determine las medidas de tendencia central y de dispersión de las ventas de acuerdo a la región, almacene los resultados en una tabla llamada \texttt{ventasconstruccion} y guarde sus resultados en una hoja de cálculo.
  \item
...
{\centering \includegraphics[width=0.7\linewidth]{EPCA_files/figure-latex/densidad-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/normal-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/normalmus-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/normalsds-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/unasd-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/dossd-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/tressd-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/normalz-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/tstudent-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/tz-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{big4size <-}\StringTok{ }\NormalTok{big4size }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
...
{\centering \includegraphics[width=0.7\linewidth]{EPCA_files/figure-latex/figura6-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{EPCA_files/figure-latex/figura7-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{construc =}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"rankingconstruccion.csv"}\NormalTok{,}\DataTypeTok{header=}\OtherTok{TRUE}\NormalTok{, }
                     \DataTypeTok{dec=}\StringTok{","}\NormalTok{, }\DataTypeTok{sep=}\StringTok{";"}\NormalTok{)}

\NormalTok{manufact =}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"rankingmanufactura.csv"}\NormalTok{,}\DataTypeTok{header=}\OtherTok{TRUE}\NormalTok{, }
                     \DataTypeTok{dec=}\StringTok{","}\NormalTok{, }\DataTypeTok{sep=}\StringTok{";"}\NormalTok{)}

\NormalTok{GRAN.CONSTRUC =}\StringTok{ }\KeywordTok{nrow}\NormalTok{(construc[}\KeywordTok{which}\NormalTok{(construc}\OperatorTok{$}\NormalTok{TAMAÑO }\OperatorTok{==}\StringTok{ "GRANDE"}\NormalTok{), ])}
\NormalTok{N.CONSTRUC =}\StringTok{ }\KeywordTok{nrow}\NormalTok{(construc)}

\NormalTok{GRAN.MANUFACT =}\StringTok{ }\KeywordTok{nrow}\NormalTok{(manufact[}\KeywordTok{which}\NormalTok{(manufact}\OperatorTok{$}\NormalTok{TAMAÑO }\OperatorTok{==}\StringTok{ "GRANDE"}\NormalTok{), ])}
\NormalTok{N.MANUFACT =}\StringTok{ }\KeywordTok{nrow}\NormalTok{(construc)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/corr3-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/vtaspub-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/centroide-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{EPCA_files/figure-latex/regre1-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{EPCA_files/figure-latex/pairs-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{EPCA_files/figure-latex/logistic-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{EPCA_files/figure-latex/logistic1-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{notas}\OperatorTok{$}\NormalTok{NIVEL =}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(notas}\OperatorTok{$}\NormalTok{NIVEL)}

\NormalTok{notas =}\StringTok{ }\NormalTok{notas }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{APRUEBA =} \KeywordTok{ifelse}\NormalTok{(FINAL}\OperatorTok{>=}\DecValTok{70}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{))}
